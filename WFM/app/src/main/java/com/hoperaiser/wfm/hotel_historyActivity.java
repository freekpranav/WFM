...
public class hotel_historyActivity extends AppCompatActivity implements SelectListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(hotel_historyActivity.this,HomeActivity.class);
                startActivity(i);
                finish();
            }
        });
