...
public class ngoadapter extends RecyclerView.Adapter<ngoadapter.ViewHolder> {
    ...
    public ngoadapter(List<Dataclass> list_data, Context context,SelectListner listner) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_ngo_nvmodel,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            food_type=(TextView)itemView.findViewById(R.id.textView);
